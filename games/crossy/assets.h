...
// two 8x8 tiles at 0xa9: the train's carriage as bg, upper row then lower, laid down column by column
extern const uint8_t kTrainBodyTiles[32];

// six 8x8 tiles at 0xb4: three 8x16 sprites left to right, one 24x16 log with rounded ends
extern const uint8_t kLogTiles[96];

// four 8x8 tiles at 0xb0: two 8x16 sprites, the left then the right half of one low slung 16x16 car
...
// eight 8x8 tiles at 0xc0: four 8x16 sprites, nose, cab, carriage and rear of a 256 px train
extern const uint8_t kTrainTiles[128];

// four 8x8 tiles at 0xe0: two 8x16 chick frames, standing with a folded wing then lifted mid hop
